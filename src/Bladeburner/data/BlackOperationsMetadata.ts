/**
 * Metadata for initializing Bladeburner BlackOperation objects
 */
import { IBlackOperationConstructorParams } from "../BlackOperation";

export const BlackOperationsMetadata: IBlackOperationConstructorParams[] = [
    // Black Operations
    {
