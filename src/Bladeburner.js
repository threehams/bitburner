...
import { BlackOperations, initBladeburnerBlackOperations } from "./BlackOperations";
import {
    City,
    CityNames,
    PopulationThreshold
...
import { GeneralActions, initBladeburnerGeneralActions } from "./GeneralActions";
...
function initBladeburner() {
    ...
    initBladeburnerGeneralActions();
    initBladeburnerBlackOperations();
}
